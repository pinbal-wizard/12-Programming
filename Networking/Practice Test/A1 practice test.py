...
def question2(file_name):
    ...
    with open(file_name, 'r') as file:
        for line in file:
            lastname, firstname = line.split(r", ")
            firstname = firstname.replace('\n', '')
            output.append(f"{firstname.upper() }, {lastname.lower()}")
    return output
